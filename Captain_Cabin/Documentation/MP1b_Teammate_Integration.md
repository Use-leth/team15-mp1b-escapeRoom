...
Status: implemented local two-scene sample. See `Verification/playmode-smoke.json` for scripted workflow evidence. Headset and full-team integration evidence are separate.

## Project and scope

- Working project: `C:\UnityProjects\mp1b`; Unity `6000.5.6f1`.
- Original project: `C:\UnityProjects\zw99_mp1a`; retained separately.
